# Classification Tools (12 tools)

Discover sensitive data in your databases using automated classification. Manage classifiers (pattern-based detectors), group them into collections, and run classification jobs that scan columns for PII, financial data, and other sensitive patterns.
...
Run an automated classification scan to discover sensitive data in your database. Jobs run asynchronously.
