...
return real customer values. Intended for support and field engineering investigations,
where the job is to read configuration and audit history and an accidental write would be a
production incident.
